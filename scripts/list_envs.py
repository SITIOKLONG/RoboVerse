...
All the environments are registered in the `RoboVerse` extension. They start
...
import RoboVerse.tasks  # noqa: F401


def main():
    """Print all environments registered in `RoboVerse` extension."""
